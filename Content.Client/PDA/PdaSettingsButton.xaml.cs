...
public sealed partial class PdaSettingsButton : ContainerButton
{
    ...
    public const string NormalBgColor = "#282828"; // Orbitra-Edit - нейтральные значения для старого стиля
    public const string HoverColor = "#606060";
    public const string PressedColor = "#484848";
    public const string DisabledFgColor = "#5a5a5a";
    public const string EnabledFgColor = "#FFFFFF";

    private readonly StyleBoxFlat _styleBox = new()
    {
        BackgroundColor = Content.Client._Orbitra.Stylesheets.OrbitraPalettes.PanelBackground // Orbitra-Edit - общий серый стиль
    };
