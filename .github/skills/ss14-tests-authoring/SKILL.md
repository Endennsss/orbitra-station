...
metadata:
  source_skill: "../../../.agents/skills/ss14-tests-authoring/SKILL.md"
---
...
For pair isolation, follow the canonical distinction between PoolSettings and direct integration options.
