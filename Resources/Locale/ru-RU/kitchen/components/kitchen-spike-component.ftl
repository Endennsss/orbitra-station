...
comp-kitchen-spike-butcher-empty = { CAPITALIZE(THE($victim)) } не имеет больше мяса для нарезки!

comp-kitchen-spike-need-tool-quality = Инструмент с возможностью { $quality } необходим для разделки { THE($target) }.
