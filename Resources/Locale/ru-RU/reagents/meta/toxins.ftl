...
reagent-name-hardlight-toxin = токсин твёрдого света

reagent-desc-hardlight-toxin = Высокотехнологичный токсин, который при метаболизме насыщает нервную систему жертвы ионизирующим излучением.
