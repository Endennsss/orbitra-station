...
petting-success-headslug = Вы гладите {THE($target)} по склизкой поверхности.

petting-success-elder-headslug = Вы гладите {THE($target)} по пульсирующей коже.
...
petting-failure-headslug = Вы пытаетесь погладить {THE($target)}, но рука погружается в плоть.

petting-failure-elder-headslug = Вы пытаетесь погладить {THE($target)}, но цель едва вас не кусает!
