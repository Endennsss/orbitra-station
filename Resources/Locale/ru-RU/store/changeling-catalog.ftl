...
changeling-catalog-armblade-sting-name = Жало клинка

changeling-catalog-armblade-sting-desc = После долгой задержки заставляет цель отрастить притуплённый клинок из руки. На трупах срабатывает мгновенно и действует дольше. Можно применить к себе.
