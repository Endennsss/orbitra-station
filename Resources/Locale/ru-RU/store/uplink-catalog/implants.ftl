...
uplink-storage-implanter-desc = Чудо блюспейса, способное спрятать содержимое, эквивалентное двум пистолетам. Сразу же полезно для хранения использованного имплантера.
...
uplink-scram-implanter-desc = Двухразовый имплант, который телепортирует вас в среднем радиусе. Попытается телепортировать вас на незанятое место, но иногда может сбоить. Страхование жизни не прилагается.
...
uplink-emp-implanter-desc = При активации создаёт небольшой ЭМИ, который обесточивает находящуюся рядом электронику. Может быть использован три раза, прежде чем разрядится внутренняя батарея. Очень маленький радиус, используйте с умом!
...
uplink-uplink-implanter-desc = Незаметно заказывайте снаряжение без использования КПК. Приложите телекристаллы прямо ко лбу, чтобы перевести их на свой счёт BitCrystal!
