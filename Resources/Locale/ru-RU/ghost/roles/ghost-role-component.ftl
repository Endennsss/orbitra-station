...
ghost-role-information-space-changeling-name = взрослая головная личинка

ghost-role-information-space-changeling-description = Взрослая головная личинка генокрада, жаждущая поглощать членов экипажа и скрываться на станции. Она особенно хрупка, поэтому ей необходимо найти мёртвое тело, чтобы принять гуманоидный облик.
