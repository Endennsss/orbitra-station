...
verb-name-mask-pull-up = Натянуть маску

verb-description-mask-pull-up = Натянуть маску.
...
verb-mask-other-pulled-up-popup-message = { CAPITALIZE($puller) } натянул { $mask } на ваше лицо.

verb-mask-other-pulled-down-popup-message = { CAPITALIZE($puller) } приспустил { $mask } с вашего лица.
