...
cmd-announce-help = { $command } <сообщение> [отправитель] [цвет] [звук] — Отправить объявление. По умолчанию отправитель — Центральное командование, цвет — золотой, звук — announce.ogg. Цвет должен быть в #RRGGBB формате.
